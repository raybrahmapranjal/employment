...
//  Client logo Carousel function by = owl.carousel.js ========================== //
	...
	// $(add_custom_field).click(function(e){ //on add input button click
		...
		// if(x < max_fields){ //max input box allowed
			// x++; //text box increment
			// $(wrapper_3).append('<div class="ls-inputicon-box"><input class="form-control m-tb10 wt-form-control" name="mytext[]" type="text" placeholder="Enter language you know"><i class="fs-input-icon fa fa-user"></i><a href="#" class="remove_field"><i class="fa fa-times"></i></a></div>'); //add input box
		// }
	// });	
